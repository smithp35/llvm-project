...
// RUN:   -fptrauth-vtable-pointer-address-discrimination \
// RUN:   -fptrauth-noakey \
// RUN:   -emit-llvm -o - | FileCheck --check-prefix=CHECKB %s
...
// CHECKB: @_ZTVN5test19ConstEvalE = external constant { [3 x ptr] }, align 8
// CHECKB: @_ZN5test12ceE = global %{{.*}} { ptr ptrauth (ptr getelementptr inbounds inrange(-16, 8) ({ [3 x ptr] }, ptr @_ZTVN5test19ConstEvalE, i32 0, i32 0, i32 2), i32 3, i64 0, ptr @_ZN5test12ceE) }, align 8
// CHECKB: @_ZTVN5test116ConstEvalDerivedE = linkonce_odr constant { [3 x ptr] } { [3 x ptr] [ptr null, ptr @_ZTIN5test116ConstEvalDerivedE, ptr ptrauth (ptr @_ZN5test19ConstEval1fEv, i32 1, i64 26259, ptr getelementptr inbounds ({ [3 x ptr] }, ptr @_ZTVN5test116ConstEvalDerivedE, i32 0, i32 0, i32 2))] },{{.*}}align 8
// CHECKB: @_ZN5test13cedE = global { ptr } { ptr ptrauth (ptr getelementptr inbounds inrange(-16, 8) ({ [3 x ptr] }, ptr @_ZTVN5test116ConstEvalDerivedE, i32 0, i32 0, i32 2), i32 3, i64 0, ptr @_ZN5test13cedE) }, align 8
