// RUN: %clang_cc1 -triple aarch64-none-elf -fsyntax-only -verify -fptrauth-intrinsics %s -fexperimental-new-constant-interpreter
// RUN: %clang_cc1 -triple aarch64-none-elf -fsyntax-only -verify -fptrauth-intrinsics %s -fexperimental-new-constant-interpreter -fptrauth-nobkey
// RUN: %clang_cc1 -triple aarch64-none-elf -fsyntax-only -verify -fptrauth-intrinsics %s -fexperimental-new-constant-interpreter -fptrauth-noakey
...
#elif __has_feature(ptrauth_noakey)
#define VALID_CODE_KEY 1
#define VALID_DATA_KEY 3
