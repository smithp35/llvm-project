...
private:
  /// Helper functions for DAG transformations.
...
///
/// Called from ComplexPattern as used in addsub_shifted_imm.
bool A64DAGToDAGISel::SelectArithImmed(SDValue N, SDValue &Val,
  ...
  // Dow we need to use optional 12 bit shift
  if (Immed >> 12 == 0) {
    ShiftAmt = 0;
  ...
  SDLoc dl(N);
  // MIOperandInfo = (ops i32imm, i32imm);
