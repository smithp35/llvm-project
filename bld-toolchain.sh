...
mkdir -p ${TOOLS_INSTALL_DIR}/lib/clang-runtimes/aarch64-none-elf/aarch64a-8.3-pauthabi
mkdir -p ${TOOLS_INSTALL_DIR}/lib/clang-runtimes/aarch64-none-elf/aarch64a-8.3-pauthabi/include
mkdir -p ${TOOLS_INSTALL_DIR}/lib/clang-runtimes/aarch64-none-elf/aarch64a-8.3-pauthabi/lib
mkdir -p ${TOOLS_INSTALL_DIR}/lib/clang-runtimes/aarch64-none-elf/aarch64a-8.3-pauthabi-noakey
mkdir -p ${TOOLS_INSTALL_DIR}/lib/clang-runtimes/aarch64-none-elf/aarch64a-8.3-pauthabi-noakey/include
mkdir -p ${TOOLS_INSTALL_DIR}/lib/clang-runtimes/aarch64-none-elf/aarch64a-8.3-pauthabi-noakey/lib
...
build_compiler_rt build-compiler-rt-pauthabi \
		  "-march=armv8.3-a -mpauthabi-profile=platform -fpie"\
		  "-march=armv8.3-a -mpauthabi-profile=platform -Wno-error=atomic-alignment -fpie"\
		  aarch64-unknown-none-elf \
		  aarch64a-8.3-pauthabi

build_compiler_rt build-compiler-rt-pauthabi-noakey \
		  "-march=armv8.3-a -mpauthabi-profile=platform+noakey -fpie"\
		  "-march=armv8.3-a -mpauthabi-profile=platform+noakey -Wno-error=atomic-alignment -fpie"\
		  aarch64-unknown-none-elf \
		  aarch64a-8.3-pauthabi-noakey

build_compiler_rt build-compiler-rt-pauthabi-nobkey \
		  "-march=armv8.3-a -mpauthabi-profile=platform+nobkey -fpie"\
		  "-march=armv8.3-a -mpauthabi-profile=platform+nobkey -Wno-error=atomic-alignment -fpie"\
		  aarch64-unknown-none-elf \
...
build_llvm_libc build-llvmlibc-pauthabi \
		"-march=armv8.3-a -mpauthabi-profile=platform -fpie"\
		"-march=armv8.3-a -mpauthabi-profile=platform -fpie -Wno-error=atomic-alignment"\
		aarch64-unknown-none-elf \
		aarch64a-8.3-pauthabi

build_llvm_libc build-llvmlibc-pauthabi-noakey \
		"-march=armv8.3-a -mpauthabi-profile=platform+noakey -fpie"\
		"-march=armv8.3-a -mpauthabi-profile=platform+noakey -fpie -Wno-error=atomic-alignment"\
		aarch64-unknown-none-elf \
		aarch64a-8.3-pauthabi-noakey

build_llvm_libc build-llvmlibc-pauthabi-nobkey \
		"-march=armv8.3-a -mpauthabi-profile=platform+nobkey -fpie"\
...
build_libcpp build-libcpp-pauthabi-noakey \
		"-march=armv8.3-a -mpauthabi-profile=platform+noakey -mmark-bti-property -fpie" \
		"-march=armv8.3-a -mpauthabi-profile=platform+noakey -Wno-error=atomic-alignment -fpie" \
		aarch64-unknown-none-elf \
		aarch64a-8.3-pauthabi-noakey

build_libcpp build-libcpp-pauthabi-nobkey \
