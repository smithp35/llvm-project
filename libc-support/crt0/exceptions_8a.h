...
EXFN_ATTR HIDDEN_ATTR void data_abort_handler(unsigned long esr_val,
...
EXFN_ATTR HIDDEN_ATTR void exception_handler() {
...
extern "C" HIDDEN_ATTR void __cexception_handler() { exception_handler(); }
#else
