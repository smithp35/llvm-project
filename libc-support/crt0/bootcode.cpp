...
HIDDEN_ATTR int main(int argc, const char **argv);
extern "C"  __attribute__((visibility("hidden"))) void __libc_init_array();
extern "C" __attribute__((visibility("hidden"))) void _platform_init();

extern __attribute__((visibility("hidden"))) char __data_source[];
extern __attribute__((visibility("hidden"))) char __data_start[];
extern __attribute__((visibility("hidden"))) char __data_size[];
extern __attribute__((visibility("hidden"))) char __bss_start[];
extern __attribute__((visibility("hidden"))) char __bss_size[];
extern __attribute__((visibility("hidden"))) char __stack;
...
[[gnu::target("branch-protection=none")]]
HIDDEN_ATTR void __bootcode_start(void) {
  ::do_start();
}
#else
